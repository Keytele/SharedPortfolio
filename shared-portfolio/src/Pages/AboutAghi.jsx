...
function SectionCard({ children, className = "" }) {
  return <div className={`rounded-xl bg-white/10 backdrop-blur-sm shadow-md p-5 ${className}`}>{children}</div>;
}
...
export default function AboutAghi() {
  ...
  return (
    <main className="px-6 pt-24 lg:px-9">
      <AboutReveal delay={0} className="flex items-center justify-between">
